	...
	<div class="space-y-4 p-6 sm:p-8 md:space-y-6">
		...
		<form class="space-y-4 md:space-y-6" method="POST" action={action_login_path}>
			...
			<div class="flex items-center justify-between">
				...
				<a
					href="#forgot"
					class="text-sm font-medium text-action-text hover:underline dark:text-action-text-dark"
				>
			...
			<input
				type="submit"
				class="w-full rounded-lg bg-action-zone px-5 py-2.5 text-center text-sm font-medium text-action-zone-text hover:bg-primary-700 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-action-zone-dark dark:text-action-zone-text-dark dark:hover:bg-primary-700 dark:focus:ring-primary-800"
		...
		<p class="text-sm font-light text-gray-500 dark:text-gray-400">
			...
			<a
				href="/register"
				class="font-medium text-action-text hover:underline dark:text-action-text-dark"
			>
